...
export declare class QdrantClient {
     ...
     */
    searchBatch(collection_name: string, { searches, consistency, }: Pick<SchemaFor<'SearchRequestBatch'>, 'searches'> & {
     ...
     */
    recommend_batch(collection_name: string, { searches, consistency }: SchemaFor<'RecommendRequestBatch'> & {
        consistency?: SchemaFor<'ReadConsistency'>;
    }): Promise<{
        id: string | number;
        version: number;
     ...
     */
    recommend(collection_name: string, { positive, negative, filter, params, limit, offset, with_payload, with_vector, score_threshold, using, lookup_from, consistency, }: Omit<SchemaFor<'RecommendRequest'>, 'limit'> & Partial<Pick<SchemaFor<'RecommendRequest'>, 'limit'>> & {
        consistency?: SchemaFor<'ReadConsistency'>;
    }): Promise<{
        id: string | number;
        version: number;
     ...
     */
    count(collection_name: string, { filter, exact }?: SchemaFor<'CountRequest'>): Promise<{
        count: number;
    }>;
    /**
     ...
     * @returns Operation result
     */
    deleteVectors(collection_name: string, { wait, ordering, points, filter, vector, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
     ...
     * @returns Operation result
     */
    searchPointGroups(collection_name: string, { consistency, vector, filter, params, with_payload, with_vector, score_threshold, group_by, group_size, limit, }: {
        consistency?: SchemaFor<'ReadConsistency'>;
     ...
     * @returns Operation result
     */
    recommendPointGroups(collection_name: string, { consistency, positive, negative, filter, params, with_payload, with_vector, score_threshold, using, lookup_from, group_by, group_size, limit, }: {
        consistency?: SchemaFor<'ReadConsistency'>;
     ...
     */
    retrieve(collection_name: string, { ids, with_payload, with_vector, consistency, }: SchemaFor<'PointRequest'> & {
        consistency?: SchemaFor<'ReadConsistency'>;
    }): Promise<{
        id: string | number;
        payload?: Record<string, unknown> | {
     ...
     * @returns Operation result
     */
    setPayload(collection_name: string, { payload, points, filter, ordering, wait, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
     ...
     * @returns Operation result
     */
    deletePayload(collection_name: string, { ordering, keys, points, filter, wait, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    ...
    getCollection(collection_name: string): Promise<{
        ...
        payload_schema: {
            [key: string]: {
                data_type: "keyword" | "integer" | "float" | "geo" | "text";
                params?: Record<string, unknown> | {
                    type: "text";
                    tokenizer?: "prefix" | "whitespace" | "word" | undefined;
     ...
     *         If timeout is reached, request will return with service error.
     */
    createCollection(collection_name: string, { timeout, vectors, hnsw_config, init_from, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, wal_config, write_consistency_factor, }: {
        timeout?: number;
     ...
     *         If timeout is reached, request will return with service error.
     */
    recreateCollection(collection_name: string, { timeout, vectors, hnsw_config, init_from, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, wal_config, write_consistency_factor, }: {
        timeout?: number;
