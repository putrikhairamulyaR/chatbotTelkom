...
class QdrantClient {
     ...
     */
    async searchBatch(collection_name, { searches, consistency, }) {
     ...
     */
    async search(collection_name, { vector, limit = 10, offset = 0, filter, params, with_payload = true, with_vector = false, score_threshold, consistency, }) {
     ...
     */
    async recommend_batch(collection_name, { searches, consistency }) {
     ...
     */
    async recommend(collection_name, { positive, negative, filter, params, limit = 10, offset = 0, with_payload = true, with_vector = false, score_threshold, using, lookup_from, consistency, }) {
     ...
     */
    async count(collection_name, { filter, exact = true } = {}) {
     ...
     * @returns Operation result
     */
    async deleteVectors(collection_name, { wait = true, ordering, points, filter, vector, }) {
     ...
     * @returns Operation result
     */
    async searchPointGroups(collection_name, { consistency, vector, filter, params, with_payload = null, with_vector = null, score_threshold, group_by, group_size, limit, }) {
     ...
     * @returns Operation result
     */
    async recommendPointGroups(collection_name, { consistency, positive, negative = [], filter, params, with_payload = null, with_vector = null, score_threshold, using = null, lookup_from = null, group_by, group_size, limit, }) {
     ...
     */
    async retrieve(collection_name, { ids, with_payload = true, with_vector, consistency, }) {
     ...
     * @returns Operation result
     */
    async setPayload(collection_name, { payload, points, filter, ordering, wait = true, }) {
     ...
     * @returns Operation result
     */
    async deletePayload(collection_name, { ordering, keys, points, filter, wait = true, }) {
     ...
     *         If timeout is reached, request will return with service error.
     */
    async createCollection(collection_name, { timeout, vectors, hnsw_config, init_from, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, wal_config, write_consistency_factor, }) {
     ...
     *         If timeout is reached, request will return with service error.
     */
    async recreateCollection(collection_name, { timeout, vectors, hnsw_config, init_from, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, wal_config, write_consistency_factor, }) {
